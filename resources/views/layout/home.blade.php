...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('bootstrap/home/img/favicons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('bootstrap/home/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('bootstrap/home/img/favicons/favicon-16x16.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('bootstrap/home/img/favicons/favicon.ico')}}">
    <link rel="manifest" href="{{asset('bootstrap/home/img/favicons/manifest.json')}}">
    <meta name="msapplication-TileImage" content="{{asset('bootstrap/home/img/favicons/mstile-150x150.png')}}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{asset('bootstrap/home/css/theme.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="#"><img src="{{asset('bootstrap/home/img/icons/logo.png')}}" alt="" width="30" /><span class="text-1000 fs-1 ms-2 fw-medium">Greeny<span class="fw-bold">HDK</span></span></a>
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
              <li class="nav-item"><a class="nav-link active active" aria-current="page" href="#">Tim Viec Lam</a></li>
              <li class="nav-item"><a class="nav-link" href="#">Quan ly CV</a></li>
              <li class="nav-item"><a class="nav-link" href="#">Kham Pha</a></li>
              ...
              <div class="row">
                <div class="col-4">
                  <div class="border-end d-flex justify-content-md-center">
                    ...
                    <div>
                      <p class="fw-bolder text-1000 mb-0">1.291.172 </p>
                ...
                <div class="col-4">
                  <div class="border-end d-flex justify-content-md-center">
                    ...
                    <div>
                      <p class="fw-bolder text-1000 mb-0">17 + </p>
                ...
                <div class="col-4">
                  <div class="d-flex justify-content-md-center">
                    ...
                    <div>
                      <p class="fw-bolder text-1000 mb-0">2.171.437 </p>
      ...
      <section class="pt-4 pt-md-6">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 text-lg-center"><img class="img-fluid mb-5 mb-md-0" src="{{asset('bootstrap/home/img/illustrations/2.png')}}" alt="" /></div>
            <div class="col-md-7 col-lg-5 text-center text-md-start">
              <h2>We Provide Many <br />Features You Can Use </h2>
              <p> You can explore the features that we provide to make the best CV.</p>
              <div class="d-flex">
                ...
                <p class="ms-2">Impress a employers.</p>
              </div>
              <div class="d-flex">
                <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                </svg>
                <p class="ms-2">Custom CV acording to your personal.</p>
              </div>
              <div class="d-flex">
                <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                </svg>
                <p class="ms-2">Increase rating to get the job.</p>
              </div>
              <div class="d-flex">
                <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                </svg>
                <p class="ms-2">Automatic recomment yourself to the employers.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100">
                <div class="card-body d-flex flex-column justify-content-around mx-auto">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{asset('bootstrap/home/img/icons/pricing.png')}}" alt="" />
      ...
      <section class="bg-100 py-7 text-center">
        ...
        <div class="container">
          <div class="row justify-content-center">
            ...
            <div class="pt-8"><img class="img-fluid" src="{{asset('bootstrap/home/img/gallery/map.png')}}" alt="" /></div>
          </div>
        </div>
        <!-- end of .container-->
                ...
                <div class="row h-100">
                    ...
                    <div class="card h-100">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center"><img class="img-fluid" src="{{asset('bootstrap/home/img/gallery/user-1.png')}}" alt="" />
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center"><img class="img-fluid" src="{{asset('bootstrap/home/img/gallery/user-2.png')}}" alt="" />
                            <div class="flex-1 ms-3">
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center"><img class="img-fluid" src="{{asset('bootstrap/home/img/gallery/user-3.png')}}" alt="" />
                            <div class="flex-1 ms-3">
                              <h6 class="mb-0 fs--1 text-1000 fw-medium">Viezh Robert</h6>
      ...
      <section class="bg-200 pt-9 pb-0">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-4 mb-3"><a href="#"><img class="d-inline-block align-middle" src="{{asset('bootstrap/home/img/icons/logo.png')}}" alt="" width="30" /><span class="d-inline-block text-1000 fs-1 ms-2 fw-medium lh-base">Lasles<span class="fw-bold">VPN</span></span></a>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{asset('bootstrap/home/vendors/@popperjs/popper.min.js')}}"></script>
    <script src="{{asset('bootstrap/home/vendors/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{asset('bootstrap/home/vendors/is/is.min.js')}}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{asset('bootstrap/home/js/theme.js')}}"></script>
